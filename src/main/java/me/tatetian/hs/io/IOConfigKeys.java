...
public class IOConfigKeys extends DFSConfigKeys {
	public static final String HS_INDEXED_RECORD_READER_GROUP_SIZE = "hs.indexed-record-reader.chunk-size";
	public static final int		 HS_INDEXED_RECORD_READER_GROUP_SIZE_DEFAULT = 1;
